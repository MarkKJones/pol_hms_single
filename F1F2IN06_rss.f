C=======================================================================
      ...
      SUBROUTINE F1F2IN06_rss(Z, A, QSQ, Wsq, F1, F2)                       
!--------------------------------------------------------------------
...
c         call CHRISTY806(W2p,Q2,F1p,Rp,sigtp,siglp)
          call ressf_2(W2p,Q2,F1p,Rp,sigtp,siglp)   !! RSS version of ressf
...
c Need avp2f term to get right behavior x>1! 
     ...
     >    qv**2 + 2. * qv * pz - avp2f(ism)
        if(w2p.gt.1.155) then
cc        call CHRISTY806(W2p,Q2,F1p,Rp,sigtp,siglp)
          call ressf_2(W2p,Q2,F1p,Rp,sigtp,siglp)   !! RSS version of ressf
