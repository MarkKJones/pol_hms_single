...
!      if(icall.ne.1) then ! OR 2/04 commented out to avoid seg. fault in g77
        delsav = delnu	! no problem in Absoft, or in standalone code.
!        icall = 1	
!      else
!	delnu = delsav
!      end if
